...
4.  **Hide Non-Essential UI Elements**:
    - Identify any elements that should _not_ appear in the printed report (e.g., navigation bars, search inputs, interactive controls, footers that are not part of the report).
